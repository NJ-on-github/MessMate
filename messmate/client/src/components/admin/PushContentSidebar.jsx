...
import './PushSidebar.css'; // We'll create this CSS file separately

const PushContentSidebar = () => {
  ...
  return (
    <div className="layout">
      ...
      {/* Main content - will move as sidebar expands */}
      <div className={`main-content ${isExpanded ? 'sidebar-expanded' : 'sidebar-collapsed'}`}>
        <h1 className="content-title">Main Content</h1>
        <p>This is the main content area. The sidebar on the left will push this content when expanded.</p>
...
export default PushContentSidebar;